...
const Arena = () => {
  return (
    ...
    <div className="md:min-h-[90%] p-0 lg:p-8 md:mt-0 mt-60">
      ...
      {/* Main container with geid layout */}
    <div className="lg:max-w-[90%] w-[90%] mx-auto grid grid-cols-1 md:grid-cols-3 gap-4 md:gap-6">
      ...
      <div className='md:col-span-2 space-y-4 md:space-y-6'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6'>
          ...
          <div className='relative overflow-hidden rounded-3xl border borderr-white aspect-square transform transition-transform duration-300 hover:scale-105'>
              
              <video className='w-full h-full object-cover'
               autoPlay loop muted playsInline
               src="public\videos\bento-card3 (1).mp4"></video>

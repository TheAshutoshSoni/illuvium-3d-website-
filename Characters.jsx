 ...
 return (
  ...
  >
    ...
    {isHovering3D && (
      ...
      transition={{ duration: 1, repeat: Number.POSITION_INFINITY}}
      />
    )}
    </motion.div>
 )
  ...
  return (
      ...
      <h1 className='text-2xl font-semibold mb-2'>{currentAvatar.name}</h1>
       ...
       <div className='space-y-3 mb-16'>
        ...
        <div className='flex items-center'>
          ...
          <samp className='ml-2'>{currentAvatar.penetrate}</samp>
        </div>
    ...
    {selectedAvatar === "VIKI" ? (
        <motion.div 
         ...
         >
           <Spline scene="https://prod.spline.design/efiLfPBEr5xFwEv8/scene.splinecode" />
      ...
      <motion.div 
         ...
         transition={{duration: 0.5 }}
         >
          <Spline scene="https://prod.spline.design/waYEXZdwO1xYAVmw/scene.splinecode" />
